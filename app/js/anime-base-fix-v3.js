(function () {
  ...
  var FIX_VERSION = "anime-base-fix-v3-20260705-keyboard-bone-material";
  var RUNS_LEFT = 1200; // about 6 minutes at 300ms
  var SKIN = 0xf2b48f;
  ...
  function setMatColor(mat, hex) {
    ...
    try { if (mat.emissive && mat.emissive.setHex) mat.emissive.setHex(0x23130c); } catch (e) {}
    try { if (mat.specular && mat.specular.setHex) mat.specular.setHex(0x111111); } catch (e) {}
    try { if (mat.uniforms) {
  ...
  function fixOneMesh(obj) {
    ...
    try { obj.frustumCulled = false; obj.castShadow = true; obj.receiveShadow = true; obj.visible = true; } catch (e) {}
    ...
    // Use a clean material if the model imported almost black or with a broken AO texture.
    replaceWithReadableMaterial(obj);
  ...
  function ensureHud() {
    ...
    hud.innerHTML =
      '<div class="pma-hud-title">Anime Base Controls</div>' +
