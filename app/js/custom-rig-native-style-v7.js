...
(function () {
  ...
  var VERSION = 'custom-rig-native-style-v7-20260710';
  ...
  function log() {
    try { console.log.apply(console, ['[PMA Custom Rig Native Style v7]'].concat([].slice.call(arguments))); } catch (e) {}
  }
  ...
  function boot() {
    log('ready', VERSION);
    log('v7 fix: keeps v5 axes behavior, but shrinks/fades huge native custom-rig controller meshes. T=translate, R=rotate, S=scale, Esc=deselect.');
    requestAnimationFrame(loop);
  }
